...
program dyn_diffusion
  ...
  call dumpio_mk_fname(EX_fname,'snapshot.dyn_diffusion','pe',SET_prc_me-1,6)
  ...
  do iteration = 1, SET_iteration
     ...
     call DEBUG_rapstart('MAIN_dyn_diffusion')
     ...
     call DEBUG_rapend  ('MAIN_dyn_diffusion')
